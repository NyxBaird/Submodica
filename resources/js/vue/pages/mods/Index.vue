...
<template>
    ...
    <div>
        ...
        <div v-if="searchPrefix === 'legacy' || $route.params.game === 'sbz'" id="coreMods">
            ...
            <a v-if="$route.params.game==='sbz'" class="btn btnBlue" href="/mods/sbz/247" target="_blank">Nautilus Library</a>
        </div>
        <div v-else id="coreMods" class="twoPointOh">
            <a class="btn btnBlue" href="/mods/sn1/141" target="_blank">BepInEx Subnautica Pack</a>
            <a class="btn btnBlue" href="/mods/sn1/246" target="_blank">Nautilus Library</a>
        </div>
        <br />
    </div>
    <hr />
